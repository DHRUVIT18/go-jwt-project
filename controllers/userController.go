...
import (
	...
	helper "github.com/DHRUVIT18/go-jwt-project/helpers"

	database "github.com/DHRUVIT18/go-jwt-project/database"
	models "github.com/DHRUVIT18/go-jwt-project/models"
...
func Signup() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		var user_id string = user.ID.Hex()
